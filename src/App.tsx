...
function App() {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 text-white flex flex-col transition-all duration-500 ${shakeScreen ? 'animate-pulse' : ''}`}>
      {/* Header with enhanced balance and settings */}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 relative">
            ...
            <button
              ...
              className="w-10 h-10 bg-gradient-to-br from-gray-700 to-gray-800 hover:from-cyan-600 hover:to-blue-700 rounded-lg flex items-center justify-center transition-all duration-300 active:scale-95 shadow-md"
              aria-label="Settings"
            ...
            {showTooltip === 'settings' && (
              <span className="absolute mt-14 ml-[-60px] bg-gray-800 text-xs text-white px-3 py-1 rounded shadow-lg z-50 animate-fade-in">Game Settings</span>
            )}
